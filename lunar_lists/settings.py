"""
Django settings for lunar_lists project.
...
ALLOWED_HOSTS = [
    '8000-markchips-lunarlists-p6fixvocst7.ws.codeinstitute-ide.net',
    '.herokuapp.com',
]
...
WSGI_APPLICATION = 'lunar_lists.wsgi.application'
